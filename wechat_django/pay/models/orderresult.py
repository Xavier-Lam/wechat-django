...
class UnifiedOrderResult(WeChatModel):
    ...
    order = m.OneToOneField(UnifiedOrder, on_delete=m.CASCADE)
    ...
    time_end = m.DateTimeField(_("pay time_end"), null=True)
    ...
    is_subscribe = m.BooleanField(_("is_subscribe"), null=True)
    sub_is_subscribe = m.BooleanField(_("sub_is_subscribe"), null=True)
